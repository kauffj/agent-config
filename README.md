...
| `bin/` | 26 command-line tools and focused harness scripts behind the above — including `fsp-mcp-install`, which registers the Free State Party's MCP server (Mycroft, as you) with every agent CLI here. |
