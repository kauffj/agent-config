...
| `bin/` | Command-line tools and focused harness scripts behind the above — including `fsp-mcp-install` for Party data and `playwright-mcp-install` for one login-sharing Brave profile across Claude and Codex. |
