...
const SCAN_DIRS = ['skills', 'agents', 'commands', 'hooks', 'instructions'];
...
function checkRefsInText(text, source) {
  ...
  const relRe = /\b(?:agents|lib|hooks|skills|commands|instructions)\/[A-Za-z0-9._/-]*\.(?:md|mjs|js|sh|json|ts)\b/g;
  let m;
